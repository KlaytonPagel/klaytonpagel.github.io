...
sandButton.onclick = function () {window.open('../Simulations/Simulations/Sand Simulation/index.html', '_self');}
circleButton.onclick = function () {window.open('../Simulations/Simulations/Circle Thing/index.html', '_self');}